function [RMAOV1] = RMAOV1varcor(X,alpha)
...
%%%%%%%% THIS IS THE BIT I CHANGED TO CORRECT THE INFLATED F VALUE DUE TO
%%%%%%%% SUBSAMPLING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
P1 = 1 - old_fcdf(F1,v1,v3);    
P2 = 1 - old_fcdf(F2,v2,v3);   
...
save(fname,'F1','P1','MSS');

disp('Repeated Measures One-Way Analysis of Variance Table. F has been corrected for subsampling')
fprintf('---------------------------------------------------------------------------\n');
disp('SOV                  SS          df           MS             Fc        P')
fprintf('---------------------------------------------------------------------------\n');
