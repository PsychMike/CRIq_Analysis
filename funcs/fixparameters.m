...
if elim_indiv;elim_outliers=1;end
if use_indivs;indiv_num = 17;else;indiv_num = 1;end
if binning;use_vars=1;uplow_quart=0;else;use_vars=0;uplow_quart=1;end %if binning, use subjects who vary between compared bins
